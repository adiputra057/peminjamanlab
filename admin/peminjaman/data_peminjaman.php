    ...
    <div class="main-panel">
                  ...
                  <table class="table expandable-table" style="width: 100%;">
                    ...
                    <tbody>
                     ...
                     $query = mysqli_query($conn, "
                      ...
                      WHERE p.status IN ('Menunggu', 'Disetujui', 'Dikembalikan')
                      ORDER BY FIELD(p.status, 'Menunggu', 'Disetujui', 'Dikembalikan', 'Ditolak'), p.tanggal_pengajuan DESC
                      ");
                          ...
                          <td class="text-center">
                            <?php if ($row['status'] === 'Menunggu'): ?>
                              <form method="POST" action="../peminjaman/peminjaman_aksi.php" class="d-flex flex-wrap justify-content-center">
                                  ...
                                  <button type="button" 
                                          class="btn btn-primary py-2 mx-1" 
                                          data-toggle="modal" 
                                          data-target="#detailModal<?= $row['id_peminjaman'] ?>">
                                      Detail
                                  </button>
                              </form>
                            <?php else: ?>
      ...
      <script>
        document.addEventListener("DOMContentLoaded", function () {
          ...
          let config = {
            disetujui: { title: "Peminjaman Disetujui!", icon: "success" },
