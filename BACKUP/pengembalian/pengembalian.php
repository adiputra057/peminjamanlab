                    ...
                    <tbody>
                        ...
                        <?php while ($row = mysqli_fetch_assoc($result)): ?>
                            ...
                            <td class="text-center">
                                <span class="btn btn-primary py-2 text-white"><?= htmlspecialchars($row['status']) ?></span>
                            </td>
                            <td class="text-center">
                                <button type="button" class="btn btn-primary py-2" data-toggle="modal" data-target="#modalDetail<?= $row['id_peminjaman'] ?>">
                                   Detail
                                </button>
                                 <button type="button" class="btn btn-danger py-2" data-toggle="modal" data-target="#modalHapus<?= $row['id_peminjaman'] ?>">
                                   Hapus
                                </button>
                            </td>
                            </tr>
